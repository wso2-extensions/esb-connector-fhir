...
public class fhirConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void readResourceWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "readResourceMandatory.json");
    ...
    public void readResourceWithOptionalParameters() throws IOException, JSONException {
        String methodName = "readResource";
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "readResourceOptional.json");
    ...
    public void readResourceWithNegativeCase() throws IOException, JSONException {
        String methodName = "readResource";
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "readResourceNegative.json");
    ...
    public void getConformanceWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "getConformanceMandatory.json");
    ...
    public void getConformanceWithOptionalParameters() throws IOException, JSONException {
        String methodName = "getConformance";
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "getConformanceOptional.json");
    ...
    public void readSpecificResourceByIdWithOptionalParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "readSpecificResourceByIdOptional.json");
    ...
    public void readSpecificResourceByIdWithNegativeParameters() throws IOException, JSONException {
        String methodName = "readSpecificResourceById";
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "readSpecificResourceByIdNegative.json");
    ...
    public void vReadResourceWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "vReadResourceMandatory.json");
    ...
    public void vReadResourceWithOptionalParameters() throws IOException, JSONException {
        String methodName = "vReadResource";
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "vReadResourceOptional.json");
    ...
    public void vReadResourceWithNegativeParameters() throws IOException, JSONException {
        String methodName = "vReadResource";
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "vReadResourceNegative.json");
    ...
    public void searchWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "searchMandatory.json");
        final String apiEndPoint = connectorProperties.getProperty("base") + "/" + connectorProperties.getProperty("type");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
    ...
    public void searchWithOptionalParameters() throws IOException, JSONException {
        String methodName = "search";
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "searchOptional.json");
        final String apiEndPoint = connectorProperties.getProperty("base") + "/" + connectorProperties.getProperty("type") + "?_format=" + connectorProperties.getProperty("format");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
    ...
    public void searchWithNegativeParameters() throws IOException, JSONException {
        String methodName = "search";
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "searchNegative.json");
        final String apiEndPoint = connectorProperties.getProperty("base") + "/" + connectorProperties.getProperty("wrongType") + "?_format=" + connectorProperties.getProperty("format");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 404);
    ...
    public void historyWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "historyMandatory.json");
    ...
    public void historyWithOptionalParameters() throws IOException, JSONException {
        String methodName = "history";
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "historyOptional.json");
    ...
    public void historyWithNegativeParameters() throws IOException, JSONException {
        String methodName = "history";
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "historyNegative.json");
    ...
    public void historyAllWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "historyAllMandatory.json");
    ...
    public void historyAllWithOptionalParameters() throws IOException, JSONException {
        String methodName = "historyAll";
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "historyAllOptional.json");
    ...
    public void historyTypeWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "historyTypeMandatory.json");
    ...
    public void historyTypeWithOptionalParameters() throws IOException, JSONException {
        String methodName = "historyType";
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "historyTypeOptional.json");
    ...
    public void historyTypeWithNegativeParameters() throws IOException, JSONException {
        String methodName = "historyType";
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURLHttp(methodName), "POST", esbRequestHeadersMap, "historyTypeNegative.json");
